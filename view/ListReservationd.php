  ...
  <div class="header_section">
      ...
      <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                        <h1 class="text-center text-uppercase font-bold mb-5">Réserver les Matériaux pour Votre Événement</h1>
    ...
    <tr>
     ...
     <style>
        ...
        <tr>
            ...
            <th>le nombre dont vous voulez supprimer</th>
            <th>id du matériel que vous voulez supprimer</th>
            ...
            <tr>
                ...
                <td align="center">
                    <form method="POST" action="updateReservation.php">
                        ...
                        <input type="hidden" value=<?PHP echo $reservation['idmateriel']; ?> name="id_reservation">
                    </form>
                </td>
                <td>
                    <a href="deleteReservation.php?id_reservation=<?php echo $reservation['idmateriel']; ?>">Delete</a>
                </td>
            </tr>
        <?php
        }
...
<body>
<a href="../ecoplusfront/ressources_materielles.php">Back to Ressources materielles </a>
    <center>
        <h1>LIST RESERVATION</h1>
    </center>
    <table border="1" align="center" width="70%">
        ...
        ?>
            <tr>
                ...
                <td align="center">
                <a href="deleteReservation.php?id_reservation=<?php echo $reservation['id_reservation']; ?>">Delete</a>
                </td>
            </tr>
        <?php
        }
