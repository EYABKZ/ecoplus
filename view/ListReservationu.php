  ...
  <div class="header_section">
      ...
      <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                        <h1 class="text-center text-uppercase font-bold mb-5">Modifier votre reservation</h1>

                     <h2 class="text-muted text-center mb-4">modifier Vos Réservations</h2>
    ...
    <tr>
     ...
     <style>
        ...
        <tr>
            ...
            <th>le nombre dont vous voulez modifier</th>
            <th>id du matériel que vous voulez modifier</th>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="updateReservation.php?id_reservation=<?php echo $reservation['idmateriel']; ?>">update</a>
                </td>
            </tr>
        <?php
        }
